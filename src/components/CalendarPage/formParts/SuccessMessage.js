...
const SuccessMessage = () => (
  <div className="success-message">
    <svg
      ...
      y="0px"
      viewBox="0 0 100 125"
      style={{ enableBackground: "new 0 0 100 100;", fill: "green", height: "150px" }}
      xmlSpace="preserve"
    >
    ...
    <h3><FormattedMessage id="thank_you_for_your_request" /></h3>
    <p><FormattedMessage id="we_sent_confirmation_check_email" /></p>
